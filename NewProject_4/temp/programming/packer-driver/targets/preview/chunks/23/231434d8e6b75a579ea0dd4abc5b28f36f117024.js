    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property({
        ...
        shiftTaskRange(index, type, taskType) {
          var tasks = taskType === TaskType.SOCIAL ? this.social_parent.children : this.social_parent.children;
          ...
          var indexPos = taskNodePosY[index];
          var firstPos = taskNodePosY[0];
          var lastPos = taskNodePosY[tasks.length - 1];
          var nodes = taskType === TaskType.SOCIAL ? this.social_parent.children : this.daily_parent.children;

          if (type === TaskNodeChangeType.UP) {
            nodes[0].setPosition(indexPos.getPosition());
            nodes[index].setPosition(firstPos.getPosition());
            var temp = nodes[index];
            nodes[index] = nodes[0];
            nodes[0] = temp;
          } else {
            nodes[tasks.length - 1].setPosition(indexPos.getPosition());
            nodes[index].setPosition(lastPos.getPosition());
            var _temp = nodes[index];
            nodes[index] = nodes[tasks.length - 1];
            nodes[tasks.length - 1] = _temp;
          } // if(type === TaskNodeChangeType.UP){
          //   // 将指定索引的元素移动到数组的最后面
...
//# sourceMappingURL=231434d8e6b75a579ea0dd4abc5b28f36f117024.js.map