      ...
      _export("drawModel", drawModel = (_dec = ccclass("drawModel"), _dec(_class = class drawModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var walletInfo = yield _this.getWalletInfo();

            if (walletInfo.walletAddress) {
              _this.drawPage.setWalletInfo(walletInfo.walletAddress);
            }
          })();
        }
        ...
        bindUxuyWallet() {
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              _this2.drawPage.setWalletInfo(walletAddress);
            } catch (error) {}
          })();
        }
        ...
        unBindWallet() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this3.drawPage.controlUnbindBtnVisible(false);

            _this3.drawPage.controlBindBtnVisible(true);
        ...
        copyAddress() {
          ...
          return _asyncToGenerator(function* () {
            navigator.clipboard.writeText(_this4.drawPage.address.string).then(function () {
...
//# sourceMappingURL=5ef1cebd3aa86bd053ae6fbb44150e7144880ff3.js.map