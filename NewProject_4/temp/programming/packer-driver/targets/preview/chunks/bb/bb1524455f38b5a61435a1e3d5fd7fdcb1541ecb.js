  ...
  return {
    ...
    execute: function () {
      ...
      _export("loginModel", loginModel = (_dec = ccclass('loginModel'), _dec(_class = class loginModel extends Component {
        ...
        checkLoginFirst() {// const isFirstLogin = await axios.post<firstLoginCheckResponseType>(loginUrls.firstLoginCheck, {
          //     id: 0
          // })
...
//# sourceMappingURL=bb1524455f38b5a61435a1e3d5fd7fdcb1541ecb.js.map