System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "lodash", "axios"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, basePageModel, loginView, GlobalConfig, _, Axios, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, walletType, walletChain, loginUrls, loginModel;
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            console.log('======', _crd && _ === void 0 ? (_reportPossibleCrUseOf_({
              error: Error()
            }), _) : _, _crd && Axios === void 0 ? (_reportPossibleCrUseOfAxios({
              error: Error()
            }), Axios) : Axios);
...
//# sourceMappingURL=149e8dc064d83e7e9947c64c5a5041a74a911d83.js.map