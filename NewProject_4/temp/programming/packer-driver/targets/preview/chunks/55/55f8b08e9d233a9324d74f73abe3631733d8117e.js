System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, instantiate, Label, Node, Prefab, ProgressBar, basePageView, GlobalData, homeView, taskNodeInfo, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, ChangeType, twitterTaskId, taskUrls, earnView;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      taskNodeInfo = _unresolved_5.taskNodeInfo;
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              if (child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                ...
                if (task.taskId !== 16) {
                  ...
                  _this3.changeDailyOrSocialTaskState(2, index, child);
                } else {
                  if (!(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    ...
                    window.Telegram.WebApp.showAlert("Please bind wallet first!", () => {
                      // 用户点击关闭按钮后调用的回调函数
                      _this3.homePage.getComponent(_crd && homeView === void 0 ? (_reportPossibleCrUseOfhomeView({
                        error: Error()
                      }), homeView) : homeView).shiftCurrentPage({
                        currentTarget: _this3.homePage.getComponent(_crd && homeView === void 0 ? (_reportPossibleCrUseOfhomeView({
                          error: Error()
          ...
          dailyTasks.forEach((task, index) => {
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              if (child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                ...
                _this4.changeDailyOrSocialTaskState(3, index, child);
              } else if (child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                error: Error()
              }), taskNodeInfo) : taskNodeInfo).taskInfo.status === 2) {
...
//# sourceMappingURL=55f8b08e9d233a9324d74f73abe3631733d8117e.js.map