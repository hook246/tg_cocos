          ...
          info.taskList.forEach((task, index) => {
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              if (_this3.taskInfo.data.taskModelResponses[0].taskList[index].status === 1) {
                ...
                _this3.changeDailyOrSocialTaskState(2, _this3.taskInfo.data.taskModelResponses[0].taskList[index], index, child);
              }
          ...
          info.taskList.forEach((task, index) => {
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              if (_this4.taskInfo.data.taskModelResponses[0].taskList[index].status === 1) {
                ...
                _this4.changeDailyOrSocialTaskState(3, _this4.taskInfo.data.taskModelResponses[0].taskList[index], index, child);
              }
...
//# sourceMappingURL=a091a0cc35f53c1e13dea417635a095d4ef8c48e.js.map