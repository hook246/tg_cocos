System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, GlobalData, _dec, _class, _crd, ccclass, property, taskUrls, inviteModel;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("inviteModel", inviteModel = (_dec = ccclass("inviteModel"), _dec(_class = class inviteModel extends Component {
        start() {}
        ...
        getTaskList() {
          return _asyncToGenerator(function* () {
            try {
              var taskList = yield window.axios.post(taskUrls.SearchTask, {
                page: 'GAME_LOBBY'
              }, {
                headers: {
...
//# sourceMappingURL=7453334e88b4504136872d68b3848be8751637dd.js.map