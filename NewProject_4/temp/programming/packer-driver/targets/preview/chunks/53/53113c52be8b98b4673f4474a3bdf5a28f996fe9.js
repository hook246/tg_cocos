        ...
        tgLogin() {
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              var encodeHasString = "auth_date=" + window.Telegram.WebApp.initDataUnsafe.auth_date + "\nfirst_name=fei\nid=6703818363lastName=wang"; //hex(HMAC_SHA256(data_check_string, secret_key)
              ...
              var loginData = yield window.axios.post(loginUrls.tgLogin, {
                ...
                id: window.Telegram.WebApp.initDataUnsafe.user.id,
                lastName: "" + window.Telegram.WebApp.initDataUnsafe.user.last_name //loginChannel: "GAME_LOBBY",
                // photoUrl: `${
...
//# sourceMappingURL=53113c52be8b98b4673f4474a3bdf5a28f996fe9.js.map