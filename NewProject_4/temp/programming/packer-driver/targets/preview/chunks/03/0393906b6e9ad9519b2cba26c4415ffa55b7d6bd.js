  ...
  return {
    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property({
          ...
          this.daily_parent.children.forEach(node => {
            ...
            (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              if (info.status === 2) {
                ...
                console.log('======refresh complete', info);
              }
            });
          });
        }
        ...
        down(index) {
          var indexPos = this.social_parent.children[index].getPosition();
          var lastPos = this.social_parent.children[this.social_parent.children.length - 1].getPosition();
          this.social_parent.children[this.social_parent.children.length - 1].setPosition(indexPos);
          this.social_parent.children[index].setPosition(lastPos);
          this.social_parent.children[index].getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
            error: Error()
          }), taskNodeInfo) : taskNodeInfo).index === this.social_parent.children.length - 1;
          this.social_parent.children[this.social_parent.children.length - 1].getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
            error: Error()
          }), taskNodeInfo) : taskNodeInfo).index = index;
          var temp = this.social_parent.children[index];
          this.social_parent.children[index] = this.social_parent.children[this.social_parent.children.length - 1];
          this.social_parent.children[this.social_parent.children.length - 1] = temp;
        ...
        down_d(index) {
          var indexPos = this.daily_parent.children[index].getPosition();
          var lastPos = this.daily_parent.children[this.daily_parent.children.length - 1].getPosition();
          this.daily_parent.children[this.daily_parent.children.length - 1].setPosition(indexPos);
          this.daily_parent.children[index].setPosition(lastPos);
          var temp = this.daily_parent.children[index];
          this.daily_parent.children[index] = this.daily_parent.children[this.daily_parent.children.length - 1];
          this.daily_parent.children[this.daily_parent.children.length - 1] = temp;
          console.log('======down', this.node.children);
        }
        ...
        refreshEarnDailyTaskState() {
          this.daily_parent.children.forEach((node, index) => {
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).taskData.data.data.taskModelResponses[1].taskResponseList[index].status === 2) {
              this.setDailyTaskCompleted(node);
            }
          });
        }
        ...
        updateSocialTaskUiByState(node, type, index) {
          ...
          if (type == ChangeType.INIT) {
            ...
            if (info.status === 1 || info.status === 0) {
              this.setSocialTaskCompleted(node);
              this.up(node.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                error: Error()
              }), taskNodeInfo) : taskNodeInfo).index);
              info.status = 2;
            } else if (info.status === 2) {
              this.setSocialTaskClaimed(node);
              this.down(node.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                error: Error()
              }), taskNodeInfo) : taskNodeInfo).index);
              info.status = 3;
            }
...
//# sourceMappingURL=0393906b6e9ad9519b2cba26c4415ffa55b7d6bd.js.map