      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var tgId = window.atob(new URLSearchParams(window.location.search).get("tgId"));
            var code = new URLSearchParams(window.location.search).get("code");
            var state = new URLSearchParams(window.location.search).get("state");

            if (tgId && code) {
              _this.bindTwitter(tgId, code, state);
            }
        ...
        bindTwitter(initData, code, state) {
          return _asyncToGenerator(function* () {
            try {
              //登录成功
              var bindData = yield window.axios.post(loginUrls.tgLogin, {
                code: code,
                state: state
              }, {
                headers: {
...
//# sourceMappingURL=4ab367f339b583a31873b32f3a1ac7a0a33bb2cd.js.map