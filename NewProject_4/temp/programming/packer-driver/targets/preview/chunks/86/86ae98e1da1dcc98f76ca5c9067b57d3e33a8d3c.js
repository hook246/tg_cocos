System.register(["__unresolved_0", "cc", "axios"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, axios, _dec, _class, _crd, ccclass, property, walletType, walletChain, loginUrls, loginModel;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec(_class = class loginModel {
        start() {
          var _this = this;
...
//# sourceMappingURL=86ae98e1da1dcc98f76ca5c9067b57d3e33a8d3c.js.map