      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (tgId && code) {
              yield _this.bindTwitter(tgId, code, state);
              return;
            }
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              var loginData = yield window.axios.post(loginUrls.tgLogin, {
                initData: (_window = window) != null && (_window$Telegram = _window.Telegram) != null && (_window$Telegram$WebA = _window$Telegram.WebApp) != null && _window$Telegram$WebA.initData ? (_window2 = window) == null ? void 0 : (_window2$Telegram = _window2.Telegram) == null ? void 0 : (_window2$Telegram$Web = _window2$Telegram.WebApp) == null ? void 0 : _window2$Telegram$Web.initData : "query_id=AAF7JpQPAwAAAHsmlA-gW6XS&user=%7B%22id%22%3A6703818363%2C%22first_name%22%3A%22fei%22%2C%22last_name%22%3A%22wang%22%2C%22language_code%22%3A%22zh-hans%22%2C%22allows_write_to_pm%22%3Atrue%7D&auth_date=1727346333&hash=885b6e6f2365df4b51c8471cad3ef83e55a92915c8dc042e52c30fd303202d82",
                // photoUrl: `${
        ...
        initOtherModel() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this3.invite.getComponent(_crd && inviteModel === void 0 ? (_reportPossibleCrUseOfinviteModel({
              error: Error()
            }), inviteModel) : inviteModel).initData(_this3.earn.getComponent(_crd && earnModel === void 0 ? (_reportPossibleCrUseOfearnModel({
              error: Error()
            }), earnModel) : earnModel).initData.bind(_this3.earn.getComponent(_crd && earnModel === void 0 ? (_reportPossibleCrUseOfearnModel({
              error: Error()
            }), earnModel) : earnModel)));
          })();
        }
          ...
          return _asyncToGenerator(function* () {
            ...
            try {
              ...
              var loginData = yield window.axios.post(loginUrls.pwdLogin, {
                ...
                initData: (_window3 = window) != null && (_window3$Telegram = _window3.Telegram) != null && (_window3$Telegram$Web = _window3$Telegram.WebApp) != null && _window3$Telegram$Web.initData ? (_window4 = window) == null ? void 0 : (_window4$Telegram = _window4.Telegram) == null ? void 0 : (_window4$Telegram$Web = _window4$Telegram.WebApp) == null ? void 0 : _window4$Telegram$Web.initData : "query_id=AAF7JpQPAwAAAHsmlA-gW6XS&user=%7B%22id%22%3A6703818363%2C%22first_name%22%3A%22fei%22%2C%22last_name%22%3A%22wang%22%2C%22language_code%22%3A%22zh-hans%22%2C%22allows_write_to_pm%22%3Atrue%7D&auth_date=1727346333&hash=885b6e6f2365df4b51c8471cad3ef83e55a92915c8dc042e52c30fd303202d82",
              ...
              if (loginData != null && (_loginData$data4 = loginData.data) != null && (_loginData$data4$data = _loginData$data4.data) != null && _loginData$data4$data.token) {
                var _loginData$data5, _loginData$data5$data;
...
//# sourceMappingURL=daf82cf59e9fdfb538821c29d975e9b3ba3bc37c.js.map