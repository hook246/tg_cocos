System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Label, Node, Prefab, ScrollView, basePageView, UIScrollSelectHorizontal, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, discoverView;
    ...
    execute: function () {
      ...
      _export("discoverView", discoverView = (_dec = ccclass("discoverView"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Prefab), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec(_class = (_class2 = class discoverView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        ...
        start() {
          ...
          this.node.getComponent(ScrollView).scrollToTop(); // this.game_father_node.on(Node.EventType.TOUCH_START, (event) => {
        ...
        openCurrentPlayUrl(event, data) {
          if (data === '1') {
            ...
            window.Telegram.WebApp.openTelegramLink(this.current_game_info.url + "?startapp=" + ((_window = window) == null ? void 0 : (_window$Telegram = _window.Telegram) == null ? void 0 : (_window$Telegram$WebA = _window$Telegram.WebApp) == null ? void 0 : (_window$Telegram$WebA2 = _window$Telegram$WebA.initDataUnsafe) == null ? void 0 : (_window$Telegram$WebA3 = _window$Telegram$WebA2.user) == null ? void 0 : _window$Telegram$WebA3.id), {
              tryInstantView: true
            });
          } else {
...
//# sourceMappingURL=7bdbbed4c021936f8d792c5c327236fad9f6867d.js.map