  ...
  return {
    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property({
        ...
        shiftTaskRange(index, type, taskType) {// const tasks = taskType === TaskType.SOCIAL ? this.social_parent.children : this.social_parent.children
...
//# sourceMappingURL=dfcae515618455f36d5b467e72bf86b3f816c402.js.map