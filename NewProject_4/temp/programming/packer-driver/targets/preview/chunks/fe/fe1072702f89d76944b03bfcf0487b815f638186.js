      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (isFirst) {
              //展示登录页面
              _this.view.getComponent(_crd && loginView === void 0 ? (_reportPossibleCrUseOfloginView({
                error: Error()
              }), loginView) : loginView).showLoginTypeBtns(true);
            } else {
              yield _this.tgLogin();
            }
          })();
        ...
        tgLogin() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (loginData != null && (_loginData$data = loginData.data) != null && (_loginData$data$data = _loginData$data.data) != null && _loginData$data$data.token) {
              ...
              _this2.view.getComponent(_crd && loginView === void 0 ? (_reportPossibleCrUseOfloginView({
                error: Error()
              }), loginView) : loginView).routeToHome();
            }
          })();
        }
        ...
        veteranLogin() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this3.view.getComponent(_crd && loginView === void 0 ? (_reportPossibleCrUseOfloginView({
              error: Error()
            }), loginView) : loginView).checkVeteranInput()) {}

            var loginData = yield window.axios.post(loginUrls.pwdLogin, {
              accountUserName: _this3.view.getComponent(_crd && loginView === void 0 ? (_reportPossibleCrUseOfloginView({
                error: Error()
              }), loginView) : loginView).getAccountInputString(),
              authDate: 0,
              firstName: "" + window.Telegram.WebApp.initDataUnsafe.user.first_name,
              hash: "" + window.Telegram.WebApp.initDataUnsafe.hash,
              id: window.Telegram.WebApp.initDataUnsafe.user.id,
              lastName: window.Telegram.WebApp.initDataUnsafe.user.last_name,
              loginChannel: "GAME_LOBBY",
              password: _this3.view.getComponent(_crd && loginView === void 0 ? (_reportPossibleCrUseOfloginView({
                error: Error()
              }), loginView) : loginView).getPasswordInputString(),
              photoUrl: "" + window.Telegram.WebApp.initDataUnsafe.user.photo_url,
              username: ''
            });
            ...
            if (loginData != null && (_loginData$data3 = loginData.data) != null && (_loginData$data3$data = _loginData$data3.data) != null && _loginData$data3$data.token) {
              ...
              _this3.view.getComponent(_crd && loginView === void 0 ? (_reportPossibleCrUseOfloginView({
                error: Error()
              }), loginView) : loginView).routeToHome();
            }
          })();
...
//# sourceMappingURL=fe1072702f89d76944b03bfcf0487b815f638186.js.map