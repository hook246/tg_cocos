    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property({
        ...
        shiftTaskRange(index, type, taskType) {
          var nodes = taskType === TaskType.SOCIAL ? this.social_parent.children : this.daily_parent.children;

          if (type === TaskNodeChangeType.UP) {
            var indexPos = nodes[index].getPosition();
            var firstPos = nodes[0].getPosition();
            this.node.children[0].setPosition(indexPos);
            this.node.children[index].setPosition(firstPos); // const temp = nodes[index]
            // this.node.children[index] = nodes[0]
            // nodes[0] = temp
          } else {
            var _indexPos = nodes[index].getPosition();

            var lastPos = nodes[this.node.children.length - 1].getPosition();
            nodes[this.node.children.length - 1].setPosition(_indexPos);
            nodes[index].setPosition(lastPos); // const temp = this.node.children[index]
...
//# sourceMappingURL=66ef4a6a02f188a53b22d9896fc13dee405b3120.js.map