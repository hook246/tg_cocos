    ...
    execute: function () {
      ...
      _export("taskUrls", taskUrls = {
        ...
        CheckIn: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://api.infinityg.ai/api/v1/task/checkIn" : "https://api.infinitytest.cc/api/v1/task/checkIn"
      });
...
//# sourceMappingURL=3d41de48de50cd699feaf0f32162db11d2a49208.js.map