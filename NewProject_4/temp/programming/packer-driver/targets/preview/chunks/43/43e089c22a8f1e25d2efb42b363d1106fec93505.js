  ...
  return {
    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property({
        ...
        shiftTaskRange(index, type, taskType) {// const nodes = taskType === TaskType.SOCIAL ? this.social_parent.children : this.daily_parent.children
...
//# sourceMappingURL=43e089c22a8f1e25d2efb42b363d1106fec93505.js.map