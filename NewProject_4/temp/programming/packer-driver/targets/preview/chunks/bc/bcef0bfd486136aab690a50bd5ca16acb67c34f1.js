      ...
      _export("drawModel", drawModel = (_dec = ccclass("drawModel"), _dec(_class = class drawModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.tonConnectUI.onStatusChange( /*#__PURE__*/_asyncToGenerator(function* (walletAndwalletInfo) {
              //连接状态改变监听事件
              console.log("change : ", walletAndwalletInfo);
              _this.account = walletAndwalletInfo;
              ...
              _this.drawPage.setWalletInfo(walletAndwalletInfo.account.address);
...
//# sourceMappingURL=bcef0bfd486136aab690a50bd5ca16acb67c34f1.js.map