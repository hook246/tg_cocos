System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      init_id = "query_id%3DAAF7JpQPAwAAAHsmlA_Unyc1%26user%3D%257B%2522id%2522%253A6703818363%252C%2522first_name%2522%253A%2522fei%2522%252C%2522last_name%2522%253A%2522wang%2522%252C%2522username%2522%253A%2522dfgsadsggfdn%2522%252C%2522language_code%2522%253A%2522zh-hans%2522%252C%2522allows_write_to_pm%2522%253Atrue%257D%26auth_date%3D1729598418%26hash%3D9e7e81ff88d8f5a8cf801eb918de0b42ad2c948dc84e2f83ae60a169a0db8fc6";
      id = 6703818363;
            ...
            try {
              ...
              if (loginData != null && (_loginData$data = loginData.data) != null && (_loginData$data$data = _loginData$data.data) != null && _loginData$data$data.token) {
                ...
                if (path != null && path.startsWith(startWithSrc)) {
                  _this2.trackPath(path.substring(startWithSrc.length));
                }
              }
            } catch (error) {
              console.log(error);
...
//# sourceMappingURL=5d18e68ceb0c2a82c69aa6aa192a8ad1380bfd20.js.map