System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfQueryDrawRespDTO(extras) {
    _reporterNs.report("QueryDrawRespDTO", "./drawView", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("drawLuckUrls", drawLuckUrls = {
        ...
        tickets_usdt: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://api.infinityg.ai/hall/api/user/info" : "http://192.168.184.19:9002/hall/api/user/info"
      ...
      _export("drawModel", drawModel = (_dec = ccclass("drawModel"), _dec(_class = class drawModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        update(deltaTime) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this2.timer_add >= 1) {
              ...
              } else if (_this2.drawPage.drawLuckyInfo.drawTime <= 0) {
                var drawLuckyInfo = yield _this2.getDrawLuckInfo();

                _this2.drawPage.setDrawLuckInfo(drawLuckyInfo.data);

                _this2.drawPage.showDrawLuckRewardInfo(drawLuckyInfo.data);
              } else {}
        ...
        initData() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (walletInfo != null && walletInfo.walletAddress) {
              ...
              _this4.drawPage.setDrawLuckInfo(drawLuckyInfo.data);
            }
          })();
        }
        ...
        getUserTicketsUsdtInfo() {
          return _asyncToGenerator(function* () {
            var info = yield window.axios.get(drawLuckUrls.info, {
              headers: {
                'Authorization': "Bearer " + (local ? local_token : (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  error: Error()
                }), GlobalData) : GlobalData).token)
...
//# sourceMappingURL=a6388552894d7c859944791ba483da27564333e7.js.map