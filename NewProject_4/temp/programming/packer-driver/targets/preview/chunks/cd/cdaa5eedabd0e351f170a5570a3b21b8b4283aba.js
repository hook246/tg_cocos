System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Animation', 'AnimationClip', 'Component', 'EventTouch', 'Label', 'Node']);
      ...
      _export("homeView", homeView = (_dec = ccclass('homeView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Node), _dec(_class = (_class2 = class homeView extends Component {
        ...
        shiftCurrentPage(btn, data) {
          ...
          return _asyncToGenerator(function* () {
            var _this$pageArray$_this, _this$pageArray$_this2;

            (_this$pageArray$_this = _this.pageArray[_this.currentPageIndex]) == null ? void 0 : (_this$pageArray$_this2 = _this$pageArray$_this.getComponent(Animation)) == null ? void 0 : _this$pageArray$_this2.play();

            _this.scheduleOnce(() => {
              _this.pageArray[_this.currentPageIndex].setPosition(-5000, 0);

              _this.pageArray[_this.currentPageIndex].setScale(1, 1);
            }, 1);
            ...
            _this.pageArray.forEach((page, index) => {
              if (Number(data) === index) {
                ...
                _this.pageArray[index].setPosition(0, 0);
              } else {//(this.pageArray[this.currentPageIndex] as Node).setPosition(-5000, 0);
              }
            });
...
//# sourceMappingURL=cdaa5eedabd0e351f170a5570a3b21b8b4283aba.js.map