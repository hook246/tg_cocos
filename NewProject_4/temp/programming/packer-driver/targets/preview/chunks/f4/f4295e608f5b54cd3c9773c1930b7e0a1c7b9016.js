      ...
      _export("inviteModel", inviteModel = (_dec = ccclass("inviteModel"), _dec(_class = class inviteModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        getTaskList() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this2.invitePage.setInviteInfo(taskList.data.data.totalInviteNum, taskList.data.data.gamePoint);

            _this2.invitePage.home.getComponent(_crd && homeView === void 0 ? (_reportPossibleCrUseOfhomeView({
              error: Error()
            }), homeView) : homeView).game_point.string = String(taskList.data.data.gamePoint);
...
//# sourceMappingURL=f4295e608f5b54cd3c9773c1930b7e0a1c7b9016.js.map