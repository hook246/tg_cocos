System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, EventType, gamesScrollControl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("gamesScrollControl", gamesScrollControl = (_dec = ccclass('gamesScrollControl'), _dec2 = property(Node), _dec3 = property({
        ...
        start() {// this.content.on(Node.EventType.TOUCH_START, this._onTouch, this);
        ...
        */
        ...
        scrollTo(idx, anim) {
          ...
          if (!anim) {
            ...
            this.isTestX = true; // Component.EventHandler.emitEvents(this.selectEvents, {
            // 	target: this,
...
//# sourceMappingURL=5a689d9bd681410e9ae6d3a3eecba64a7940f154.js.map