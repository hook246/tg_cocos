    ...
    execute: function () {
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec(_class = class NewComponent extends Component {
        ...
        downBottom(startIndex) {
          for (var index = startIndex; index <= this.node.children.length - 2; index++) {
            this.swap(index, index + 1);
          }
        }

        swap(from, to) {
          var indexPos = this.node.children[from].getPosition();
          var firstPos = this.node.children[to].getPosition();
          this.node.children[to].setPosition(indexPos);
          this.node.children[from].setPosition(firstPos);
          var temp = this.node.children[from];
        ...
        down(index) {
          var indexPos = this.node.children[index].getPosition();
          var lastPos = this.node.children[this.node.children.length - 1].getPosition();
...
//# sourceMappingURL=70362569c62e2620a6356ddd39ac75f7a859216e.js.map