    ...
    execute: function () {
      ...
      _export("taskUrls", taskUrls = {
        SearchTask: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://api.infinityg.ai/api/v1/task/list" : "https://api.infinitytest.cc/api/v1/task/list",
        ClaimReward: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://api.infinityg.ai/api/v1/task/claim" : "https://api.infinitytest.cc/api/v1/task/claim",
        CompleteTask: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://api.infinityg.ai/api/v1/task/complete" : "https://api.infinitytest.cc/api/v1/task/complete",
        CheckIn: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData) ? "https://api.infinityg.ai/api/v1/task/checkIn" : "https://api.infinitytest.cc/api/v1/task/checkIn",
        RefreshTwitter: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData) ? "https://api.infinityg.ai/api/v1/oauth/refreshTwitterCode" : "https://api.infinitytest.cc/api/v1/oauth/refreshTwitterCode"
      });
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property({
        ...
        refreshTwitterCode() {
          return _asyncToGenerator(function* () {
            var data = yield window.axios.post(taskUrls.RefreshTwitter, {}, {
              headers: {
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              if (child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                ...
                if (task.taskId !== 16) {
                  ...
                  var task_response = yield _this5.completeTask(task.taskId);

                  if ((task_response == null ? void 0 : task_response.data.code) === '2004') {
                    yield _this5.refreshTwitterCode();
                  } else {
                    _this5.changeDailyOrSocialTaskState(2, index, child);

                    _this5.shiftTaskRange(index, TaskNodeChangeType.UP, TaskType.SOCIAL);
                  }
                } else {
                  if (!(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    ...
                    var _task_response = yield _this5.completeTask(task.taskId);

                    if ((_task_response == null ? void 0 : _task_response.data.code) === '2004') {
                      yield _this5.refreshTwitterCode();
                    } else {
                      _this5.changeDailyOrSocialTaskState(2, index, child);

                      _this5.shiftTaskRange(index, TaskNodeChangeType.UP, TaskType.DAILY);
                    }
                  }
                }
                ...
                _this5.shiftTaskRange(index, TaskNodeChangeType.DOWN, TaskType.SOCIAL);
              }
            }), this);
          ...
          dailyTasks.forEach((task, index) => {
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              if (child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                ...
                var _child$getComponent$t, _child$getComponent$t2;

                //跳转大厅
                if ((_child$getComponent$t = child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                  error: Error()
                }), taskNodeInfo) : taskNodeInfo).taskInfo) != null && (_child$getComponent$t2 = _child$getComponent$t.remark) != null && _child$getComponent$t2.length) {
                  var _window, _window$Telegram, _window$Telegram$WebA;

                  var gameInitData = new URLSearchParams(window.location.search).get("gameData");

                  if ((_window = window) != null && (_window$Telegram = _window.Telegram) != null && (_window$Telegram$WebA = _window$Telegram.WebApp) != null && _window$Telegram$WebA.initData) {
                    var _window2, _window2$Telegram, _window2$Telegram$Web;

                    window.Telegram.WebApp.openTelegramLink(child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                      error: Error()
                    }), taskNodeInfo) : taskNodeInfo).taskInfo.remark + "?startapp=" + window.btoa((_window2 = window) == null ? void 0 : (_window2$Telegram = _window2.Telegram) == null ? void 0 : (_window2$Telegram$Web = _window2$Telegram.WebApp) == null ? void 0 : _window2$Telegram$Web.initData), {
                      tryInstantView: true
                    });
                  } else if (gameInitData) {
                    window.Telegram.WebApp.openTelegramLink(child.getComponent(_crd && taskNodeInfo === void 0 ? (_reportPossibleCrUseOftaskNodeInfo({
                      error: Error()
                    }), taskNodeInfo) : taskNodeInfo).taskInfo.remark + "?startapp=" + gameInitData, {
                      tryInstantView: true
                    });
                  }
                } else {
                ...
                _this6.shiftTaskRange(index, TaskNodeChangeType.DOWN, TaskType.DAILY);
              }
            }), this);
        ...
        up(index) {
          var indexPos = this.social_parent.children[index].getPosition();
          var firstPos = this.social_parent.children[0].getPosition();
          ...
          var temp = this.social_parent.children[index];
        ...
        down(index) {
          ...
          var indexPos = this.social_parent.children[index].getPosition();
          var lastPos = this.social_parent.children[lengthUnclaimed - 1].getPosition();
        ...
        up_d(index) {
          var indexPos = this.daily_parent.children[index].getPosition();
          var firstPos = this.daily_parent.children[0].getPosition();
          this.daily_parent.children[0].setPosition(indexPos);
          this.daily_parent.children[index].setPosition(firstPos);
          var temp = this.daily_parent.children[index];
        ...
        down_d(index) {
          ...
          var indexPos = this.daily_parent.children[index].getPosition();
          var lastPos = this.daily_parent.children[lengthUnclaimed - 1].getPosition();
        ...
        downSocial(startIndex) {
          ...
          //   }
          // })
          for (var index = startIndex; index <= this.social_parent.children.length - 2; index++) {
            this.swapSocial(index, index + 1);
          }
        }
        ...
        downDaily(startIndex) {
          ...
          //   }
          // })
          for (var index = startIndex; index <= this.daily_parent.children.length - 2; index++) {
            this.swapDaily(index, index + 1);
          }
        }

        swapDaily(indexFrom, indexTo) {
          var indexPos = this.daily_parent.children[indexFrom].getPosition();
          var firstPos = this.daily_parent.children[indexTo].getPosition();
          this.daily_parent.children[indexTo].setPosition(indexPos);
          this.daily_parent.children[indexFrom].setPosition(firstPos);
          var temp = this.daily_parent.children[indexFrom];
        ...
        swapSocial(indexFrom, indexTo) {
          var indexPos = this.social_parent.children[indexFrom].getPosition();
          var firstPos = this.social_parent.children[indexTo].getPosition();
          this.social_parent.children[indexTo].setPosition(indexPos);
          this.social_parent.children[indexFrom].setPosition(firstPos);
          var temp = this.social_parent.children[indexFrom];
        ...
        shiftTaskRange(index, type, taskType) {
          var nodes = taskType === TaskType.SOCIAL ? this.social_parent.children : this.daily_parent.children; // if(type === TaskNodeChangeType.UP){
        ...
        checkTwitterPre() {
          var twitterOauthUrl = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).isProduction ? "https://www.infinityg.ai?tgId=" + (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).token : "https://www.infinitytest.cc?tgId=" + (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          ...
          return _asyncToGenerator(function* () {
            ...
            if (type === ChangeType.INIT) {
              if (info.status === 1 || info.status === 0) {
                _this8.setDailyTaskUncompleted(node);
                ...
                _this8.setDailyTaskCompleted(node);

                node.getChildByName("ProgressBar").getComponent(ProgressBar).progress = info.value1 / info.totalValue1;
                node.getChildByName('progress_text').getComponent(Label).string = info.value1 / info.totalValue1 * 100 + "%";
              } else if (info.status === 3) {
                _this8.setDailyTaskClaimed(node);
              ...
              if (info.status === 1 || info.status === 0) {} else if (info.status === 2) {
                ...
                _this8.downDaily(_this8.daily_parent.children.indexOf(node));
...
//# sourceMappingURL=0666595d04ae97107756b6568360a522011182fc.js.map