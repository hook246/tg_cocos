    ...
    execute: function () {
      ...
      _export("drawModel", drawModel = (_dec = ccclass("drawModel"), _dec(_class = class drawModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        setTimerCount() {
          ...
          return _asyncToGenerator(function* () {
            for (var index = Math.round(_this2.drawPage.drawLuckyInfo.drawTime / 1000); index > 0; index--) {
              yield (_crd && PromiseUtils === void 0 ? (_reportPossibleCrUseOfPromiseUtils({
                error: Error()
              }), PromiseUtils) : PromiseUtils).wait(1000);

              var current_time = _this2.formatTimestamp(index * 1000);

              _this2.drawPage.timer.string = current_time;

              if (index === 0) {
                yield _this2.getDrawLuckInfo();

                _this2.drawPage.setDrawLuckInfo(_this2.drawPage.drawLuckyInfo);

                _this2.drawPage.showDrawLuckRewardInfo(_this2.drawPage.drawLuckyInfo);
              } else if (_this2.drawPage.drawLuckyInfo.drawTime <= 5) {
        ...
        update(deltaTime) {
          ...
          return _asyncToGenerator(function* () {
            var _this3$drawPage$drawL;

            if (!((_this3$drawPage$drawL = _this3.drawPage.drawLuckyInfo) != null && _this3$drawPage$drawL.drawTime)) {
              return;
            }

            _this3.timer_add = _this3.timer_add + deltaTime;

            if (_this3.timer_add >= 1) {
              _this3.drawPage.drawLuckyInfo.drawTime = _this3.drawPage.drawLuckyInfo.drawTime - 1000;

              if (_this3.drawPage.drawLuckyInfo.drawTime <= 5000 && _this3.drawPage.drawLuckyInfo.drawTime > 0) {
                _this3.drawPage.setJoinBtnUseAble(false);
              } else if (_this3.drawPage.drawLuckyInfo.drawTime <= 0) {// const drawLuckyInfo = await this.getDrawLuckInfo()
                // this.drawPage.setDrawLuckInfo(drawLuckyInfo.data.data)
                // this.drawPage.showDrawLuckRewardInfo(drawLuckyInfo.data.data)
              } else {}

              var current_time = _this3.formatTimestamp(_this3.drawPage.drawLuckyInfo.drawTime);

              _this3.drawPage.timer.string = current_time;
              _this3.timer_add = 0;
            }
          })();
        }
        ...
        bindTonWallet() {
          ...
          return _asyncToGenerator(function* () {
            if (_this4.tonConnectUI.connected) {
              yield _this4.tonConnectUI.disconnect();
            }

            _this4.tonConnectUI.onStatusChange( /*#__PURE__*/_asyncToGenerator(function* (walletAndwalletInfo) {
              //连接状态改变监听事件
              ...
              _this4.account = walletAndwalletInfo;
              ...
              _this4.drawPage.setWalletInfo(walletAndwalletInfo.account.address);
            }));

            yield _this4.tonConnectUI.openModal();
          })();
        } //设置当前的倒计时
        ...
        initData() {
          ...
          return _asyncToGenerator(function* () {
            var walletInfo = yield _this5.getWalletInfo();

            if (walletInfo != null && walletInfo.walletAddress) {
              _this5.drawPage.setWalletInfo(walletInfo == null ? void 0 : walletInfo.walletAddress);
            }

            var ticketsInfo = yield _this5.getUserTicketsUsdtInfo();

            _this5.drawPage.setCurrentTicketsUsdtCount(ticketsInfo.data);

            yield _this5.getDrawLuckInfo();
          })();
        }
        ...
        bindUxuyWallet() {
          ...
          return _asyncToGenerator(function* () {
            try {
              _this6.drawPage.controlConnectWalletBtnsVisible(false);

              _this6.drawPage.home.getChildByName('tap_btns').active = true;
              var walletAddress;
              var walletChain;
              ...
              _this6.drawPage.setWalletInfo(walletAddress);
            } catch (error) {}
          })();
        }
        ...
        unBindWallet() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this7.drawPage.controlUnbindBtnVisible(false);

            _this7.drawPage.controlBindBtnVisible(true);
        ...
        copyAddress() {
          ...
          return _asyncToGenerator(function* () {
            navigator.clipboard.writeText(_this8.drawPage.address.string).then(function () {
        ...
        getDrawLuckInfo() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (drawInfo.data.data.join) {
              _this9.drawPage.setJoinBtnUseAble(false);
            } else {
              _this9.drawPage.setJoinBtnUseAble(true);
            }

            _this9.drawPage.setDrawLuckInfo(drawInfo.data.data);

            yield _this9.setTimerCount();
          })();
        }
        ...
        joinDrawLucy() {
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              _this10.drawPage.setJoinBtnUseAble(false);
        ...
        claimReward(drawId) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this11.drawPage.setCurrentTicketsUsdtCount(reward.data);

            _this11.drawPage.closeDrawLuckRewardInfo();
...
//# sourceMappingURL=42a0ac7e07e19b13bdc4a840e3bdd8f5f15af070.js.map