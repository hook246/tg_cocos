          ...
          return _asyncToGenerator(function* () {
            ...
            if (type === ChangeType.INIT) {
              if (info.status === 1 || info.status === 0) {
                ...
                node.getChildByName("ProgressBar").getComponent(ProgressBar).value = info.value1 / info.totalValue1;
...
//# sourceMappingURL=42765187121beba3f0f999f5809a3bbfe9194758.js.map