System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, basePageModel, loginView, GlobalData, drawModel, discoverModel, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, tg_token, macSHA_secret, walletType, walletChain, loginUrls, loginModel;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        error: Error()
        ...
        initOtherModel() {
          this.draw.getComponent(_crd && drawModel === void 0 ? (_reportPossibleCrUseOfdrawModel({
            error: Error()
          }), drawModel) : drawModel).initData();
          this.discover.getComponent(_crd && discoverModel === void 0 ? (_reportPossibleCrUseOfdiscoverModel({
            error: Error()
...
//# sourceMappingURL=428dc97a1ea2f8c51c44de568c5e0c6f96f6855d.js.map