System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, CCInteger, CCFloat, EventHandler, log, UITransform, error, instantiate, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _class3, _crd, ccclass, property, EventType, UIScrollSelectHorizontal;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'CCInteger', 'CCFloat', 'EventHandler', 'log', 'UITransform', 'error', 'instantiate']);
      ...
      _export("UIScrollSelectHorizontal", UIScrollSelectHorizontal = (_dec = ccclass('UIScrollSelectHorizontal'), _dec2 = property(Node), _dec3 = property({
        ...
        onLoad() {
          for (var i = 0; i < 6; i++) {
            var node_child = instantiate(this.instantiate_node);
...
//# sourceMappingURL=bfd5f6f475b3b8f3ed40521b964ef54796b72694.js.map