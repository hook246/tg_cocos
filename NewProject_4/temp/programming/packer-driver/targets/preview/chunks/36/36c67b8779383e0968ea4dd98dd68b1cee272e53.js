      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property({
        ...
        shiftTaskRange(index, type, taskType) {
          ...
          if (type === TaskNodeChangeType.UP) {
            // 将指定索引的元素移动到数组的最后面
            var [pointToMove] = taskNodePosY.splice(index, 1); // 移除指定索引的元素

            taskNodePosY.push(pointToMove); // 将该元素添加到数组的末尾
          } else {
            var [_pointToMove] = taskNodePosY.splice(index, 1); // 移除指定索引的元素

            taskNodePosY.push(_pointToMove); // 将该元素添加到数组的末尾
          }
...
//# sourceMappingURL=36c67b8779383e0968ea4dd98dd68b1cee272e53.js.map