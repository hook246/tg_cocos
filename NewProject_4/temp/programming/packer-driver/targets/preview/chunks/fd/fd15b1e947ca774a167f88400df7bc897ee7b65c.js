System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      init_id = "query_id=N7QLQP2UT8CGSOFLQ15YM0ED&user=%7B%22allows_write_to_pm%22%3Atrue%2C%22first_name%22%3A%22fei%22%2C%22id%22%3A6703818363%2C%22language_code%22%3A%22zh-hans%22%2C%22last_name%22%3A%22wang%22%2C%22username%22%3A%22dfgsadsggfdn%22%7D&auth_date=1728733846&hash=1d4b901625f8165d8dec27cb1693d87f9b207940f6fd0938cf309466f69a87f0";
      id = 6703818363;
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        tgLogin() {
          ...
          return _asyncToGenerator(function* () {
            try {
              var _window3, _window3$Telegram, _window3$Telegram$Web, _window4, _window4$Telegram, _window4$Telegram$Web, _loginData$data, _loginData$data$data;
        ...
        veteranLogin() {
          ...
          return _asyncToGenerator(function* () {
            ...
            try {
              var _window5, _window5$Telegram, _window5$Telegram$Web, _window6, _window6$Telegram, _window6$Telegram$Web, _loginData$data4, _loginData$data4$data;

              var inviteCode = new URLSearchParams(window.location.search).get("tgWebAppStartParam");
              var gameInitData = new URLSearchParams(window.location.search).get("gameData");
              var loginData = yield window.axios.post(loginUrls.pwdLogin, {
                accountUserName: _this4.loginView.getAccountInputString(),
                initData: (_window5 = window) != null && (_window5$Telegram = _window5.Telegram) != null && (_window5$Telegram$Web = _window5$Telegram.WebApp) != null && _window5$Telegram$Web.initData ? (_window6 = window) == null ? void 0 : (_window6$Telegram = _window6.Telegram) == null ? void 0 : (_window6$Telegram$Web = _window6$Telegram.WebApp) == null ? void 0 : _window6$Telegram$Web.initData : gameInitData ? window.atob(gameInitData) : init_id,
...
//# sourceMappingURL=fd15b1e947ca774a167f88400df7bc897ee7b65c.js.map