        ...
        initData() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (walletInfo != null && walletInfo.walletAddress) {
              ...
              var ticketsInfo = yield _this3.getUserTicketsUsdtInfo();

              _this3.drawPage.setCurrentTicketsUsdtCount(ticketsInfo.data);

              var drawLuckyInfo = yield _this3.getDrawLuckInfo();

              _this3.drawPage.setDrawLuckRewardInfo(drawLuckyInfo.data);
            }
          })();
        }
...
//# sourceMappingURL=9cb4b30b85a67771399b733d0b3acfce67a4cea2.js.map