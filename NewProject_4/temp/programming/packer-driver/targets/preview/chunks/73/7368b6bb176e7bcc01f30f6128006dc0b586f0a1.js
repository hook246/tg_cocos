          ...
          return _asyncToGenerator(function* () {
            ...
            _this.pageArray.forEach((page, index) => {
              if (Number(data) === index) {
                ...
                _this.pageArray[index].setPosition(0, 0); // (this.pageArray[index] as Node).getComponent(UIOpacity).opacity = 255

              } else {
                _this.pageArray[_this.currentPageIndex].setPosition(-5000, 0); // tween(this.pageArray[index].getComponent(UIOpacity))?.to(0.5, { opacity: 0 }).start();
                // this.scheduleOnce(()=>{
...
//# sourceMappingURL=7368b6bb176e7bcc01f30f6128006dc0b586f0a1.js.map