System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Label, Node, Prefab, basePageView, UIScrollSelectHorizontal, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, discoverView_arrow, discoverView;
  ...
  return {
    ...
    execute: function () {
      ...
      discoverView_arrow = 'discoverView_arrow';

      _export("discoverView", discoverView = (_dec = ccclass("discoverView"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Prefab), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class discoverView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "arrow", _descriptor10, this);

          _initializerDefineProperty(this, "arrow_s", _descriptor11, this);
        ...
        openCurrentPlayUrl(event, data) {
          ...
          if (data === '1') {
            ...
            if ((_window = window) != null && (_window$Telegram = _window.Telegram) != null && (_window$Telegram$WebA = _window$Telegram.WebApp) != null && _window$Telegram$WebA.initData) {
              var _window2, _window2$Telegram, _window2$Telegram$Web, _window2$Telegram$Web2, _window2$Telegram$Web3;

              window.Telegram.WebApp.openTelegramLink(this.current_game_info.url + "?startapp=TG" + ((_window2 = window) == null ? void 0 : (_window2$Telegram = _window2.Telegram) == null ? void 0 : (_window2$Telegram$Web = _window2$Telegram.WebApp) == null ? void 0 : (_window2$Telegram$Web2 = _window2$Telegram$Web.initDataUnsafe) == null ? void 0 : (_window2$Telegram$Web3 = _window2$Telegram$Web2.user) == null ? void 0 : _window2$Telegram$Web3.id), {
                tryInstantView: true
              });
            } else if (gameInitData) {
              var urlComponent = decodeURIComponent(window.atob(gameInitData));
              var tgId = JSON.parse(decodeURIComponent(urlComponent).split('&')[1].split('=')[1]).id;
              window.Telegram.WebApp.openTelegramLink(this.current_game_info.url + "?startapp=TG" + tgId, {
                tryInstantView: true
              });
            }
          } else {
            var _window3, _window3$Telegram, _window3$Telegram$Web, _window5, _window5$Telegram, _window5$Telegram$Web;

            if ((_window3 = window) != null && (_window3$Telegram = _window3.Telegram) != null && (_window3$Telegram$Web = _window3$Telegram.WebApp) != null && _window3$Telegram$Web.initData) {
              var _window4, _window4$Telegram, _window4$Telegram$Web;

              window.Telegram.WebApp.openTelegramLink(this.current_ugc_info.url + "?startapp=" + window.btoa((_window4 = window) == null ? void 0 : (_window4$Telegram = _window4.Telegram) == null ? void 0 : (_window4$Telegram$Web = _window4$Telegram.WebApp) == null ? void 0 : _window4$Telegram$Web.initData), {
                tryInstantView: true
              });
            } else if (gameInitData) {
              window.Telegram.WebApp.openTelegramLink(this.current_ugc_info.url + "?startapp=" + gameInitData, {
                tryInstantView: true
              });
            }

            console.log('====Telegram', this.current_ugc_info.url + "?startapp=" + window.btoa((_window5 = window) == null ? void 0 : (_window5$Telegram = _window5.Telegram) == null ? void 0 : (_window5$Telegram$Web = _window5$Telegram.WebApp) == null ? void 0 : _window5$Telegram$Web.initData));
          }
        }
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "arrow", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "arrow_s", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=9568fc3867d68256abe82880956ff31bff194308.js.map