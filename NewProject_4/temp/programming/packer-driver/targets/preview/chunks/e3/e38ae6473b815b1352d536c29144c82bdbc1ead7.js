System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'CCInteger', 'CCFloat', 'EventHandler', 'log', 'UITransform', 'error']);
      ...
      _export("UIScrollSelectHorizontal", UIScrollSelectHorizontal = (_dec = ccclass('UIScrollSelectHorizontal'), _dec2 = property(Node), _dec3 = property({
        ...
        */
        ...
        start() {
          this.content.on(Node.EventType.TOUCH_START, this._onTouch, this.content);
          this.content.on(Node.EventType.TOUCH_MOVE, this._onTouch, this.content);
          this.content.on(Node.EventType.TOUCH_END, this._onTouchEnd, this.content);
          this.content.on(Node.EventType.TOUCH_CANCEL, this._onTouchEnd, this.content);
        }
        ...
        update(dt) {
          ...
          if (lx * cx < 0 && Math.abs(cx) < this.deltaX) {
            ...
            for (var _i = 0; _i < this.childs.length; _i++) {
              if (Math.abs(this.childs[_i].position.x) <= Math.abs(stepx)) {
...
//# sourceMappingURL=e38ae6473b815b1352d536c29144c82bdbc1ead7.js.map