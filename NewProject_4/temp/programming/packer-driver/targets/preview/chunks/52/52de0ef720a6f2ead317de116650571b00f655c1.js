System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EditBox', 'EventTouch', 'Label', 'Node', 'tween', 'UIOpacity']);
      ...
      _export("profileView", profileView = (_dec = ccclass('profileView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(EditBox), _dec(_class = (_class2 = class profileView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        ...
        setTwitterInfo() {
          var _window, _window$Telegram, _window$Telegram$WebA, _window$Telegram$WebA2, _window$Telegram$WebA3, _window2, _window2$Telegram, _window2$Telegram$Web, _window2$Telegram$Web2, _window2$Telegram$Web3, _ref, _ref$username, _window3, _window3$Telegram, _window3$Telegram$Web, _window3$Telegram$Web2, _window3$Telegram$Web3;
          ...
          if ((_ref = _crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData) != null && (_ref$username = _ref.username) != null && _ref$username.length) {
        ...
        editUserInfo() {
          ...
          return _asyncToGenerator(function* () {
            try {
              var url = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
              }), GlobalData) : GlobalData).isProduction ? 'https://api.infinityg.ai/api/v1/user/info/edit' : 'https://api.infinitytest.cc/api/v1/user/info/edit';
              var userInfo = yield window.axios.post(url, {
                avatar: _this.avatar,
                userName: _this.edit_username.string ? _this.edit_username.string : (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  error: Error()
                }), GlobalData) : GlobalData).username
              }, {
                headers: {
              ...
              (_crd && WebUtils === void 0 ? (_reportPossibleCrUseOfWebUtils({
                error: Error()
              }), WebUtils) : WebUtils).getResouceImg(_this.avatar, _this.user_avatar);

              _this.home.getComponent(_crd && homeView === void 0 ? (_reportPossibleCrUseOfhomeView({
                error: Error()
              }), homeView) : homeView).setProfile(_this.avatar);

              _this.user_name.string = _this.edit_username.string ? _this.edit_username.string : (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
              }), GlobalData) : GlobalData).username;
...
//# sourceMappingURL=52de0ef720a6f2ead317de116650571b00f655c1.js.map