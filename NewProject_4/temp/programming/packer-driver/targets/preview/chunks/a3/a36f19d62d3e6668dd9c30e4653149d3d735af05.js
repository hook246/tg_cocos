          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this.isUseMock) {
              window.Telegram.WebApp.initDataUnsafe = {
                ...
                authDate: _this.isUseMock ? 1726658361 : window.Telegram.WebApp.initDataUnsafe.auth_date,
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              var loginData = yield window.axios.post(loginUrls.tgLogin, {
                authDate: _this3.isUseMock ? 1726658361 : window.Telegram.WebApp.initDataUnsafe.auth_date,
                ...
                photoUrl: "" + (_this3.isUseMock ? "" : window.Telegram.WebApp.initDataUnsafe.user.photo_url),
                username: ""
              });
          ...
          return _asyncToGenerator(function* () {
            ...
            try {
              ...
              var loginData = yield window.axios.post(loginUrls.pwdLogin, {
                ...
                authDate: _this4.isUseMock ? 1726658361 : window.Telegram.WebApp.initDataUnsafe.auth_date,
...
//# sourceMappingURL=a36f19d62d3e6668dd9c30e4653149d3d735af05.js.map