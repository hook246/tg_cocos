          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              var loginData = yield window.axios.post(loginUrls.tgLogin, {
                ...
                // }`,
                inviteCode: !inviteCode.startsWith(startWithSrc) && pathMaps.indexOf(inviteCode) < 0 && inviteCode ? (_JSON$parse = JSON.parse(window.atob(inviteCode))) == null ? void 0 : _JSON$parse.inviteCode : ""
              });
...
//# sourceMappingURL=b35168ec78b069ca0ed03bba9753e52093358524.js.map