System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, EditBox, Label, Node, basePageView, GlobalData, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, avatars, profileView;
  ...
  return {
    ...
    execute: function () {
      ...
      avatars = ['images/avatar/1.jpg', 'images/avatar/2.jpg', 'images/avatar/3.jpg', 'images/avatar/4.jpg', 'images/avatar/5.jpg'];

      _export("profileView", profileView = (_dec = ccclass('profileView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(EditBox), _dec(_class = (_class2 = class profileView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "username", _descriptor9, this);
        ...
        editUserInfo() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var userInfo = yield window.axios.post(url, {
              avatar: "avatar",
              userName: _this.user_name.string
            }, {
              headers: {
        ...
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "username", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=caf57c27f6afa7c1f08fff6d0800009834bd6716.js.map