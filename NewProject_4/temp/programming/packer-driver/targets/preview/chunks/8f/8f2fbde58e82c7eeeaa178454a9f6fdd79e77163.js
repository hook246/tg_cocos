System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, basePageView, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, discoverView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("discoverView", discoverView = (_dec = ccclass('discoverView'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class discoverView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        error: Error()
        ...
        shiftCurrentPlayType(btn, data) {
          this.shift_btns.forEach(node => {
            ...
            node.getChildByName('unselected_lable').active = false;
          });
...
//# sourceMappingURL=8f2fbde58e82c7eeeaa178454a9f6fdd79e77163.js.map