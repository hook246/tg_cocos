          ...
          return _asyncToGenerator(function* () {
            ...
            _this.pageArray.forEach((page, index) => {
              if (Number(data) === index) {
                ...
                _this.pageArray[index].setPosition(-5000, 0); // tween(this.pageArray[index].getComponent(UIOpacity))?.to(0.5, { opacity: 0 }).start();
                // this.scheduleOnce(()=>{
...
//# sourceMappingURL=888427126c9d464c3d5b8a6844724da57be57df2.js.map