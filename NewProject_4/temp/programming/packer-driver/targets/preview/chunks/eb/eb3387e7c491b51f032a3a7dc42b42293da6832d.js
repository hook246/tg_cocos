        ...
        tgLogin() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var loginData = yield window.axios.post(loginUrls.tgLogin, {
              authDate: 0,
              firstName: "" + (_this2.isUseMock ? 'fei' : window.Telegram.WebApp.initDataUnsafe.user.first_name),
              hash: "" + (_this2.isUseMock ? '8346cc12bf427171ceb09f9a75f63d00f37edb017c921641d6036e9758abf134' : window.Telegram.WebApp.initDataUnsafe.hash),
              id: _this2.isUseMock ? 6703818363 : window.Telegram.WebApp.initDataUnsafe.user.id,
              lastName: "" + (_this2.isUseMock ? 'wang' : window.Telegram.WebApp.initDataUnsafe.user.last_name),
              loginChannel: "GAME_LOBBY",
              photoUrl: "" + (_this2.isUseMock ? 'https://t.me/i/userpic/320/X12MAmP3LRE86nyBFSTIu7gHQ3DMMFyJG_guP3PXbe1ra9sUBt3UL5wqLO7SUrl6.svg' : window.Telegram.WebApp.initDataUnsafe.user.photo_url),
              username: ''
            });
        ...
        veteranLogin() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var loginData = yield window.axios.post(loginUrls.pwdLogin, {
              ...
              loginChannel: "GAME_LOBBY",
              password: _this3.loginView.getPasswordInputString(),
...
//# sourceMappingURL=eb3387e7c491b51f032a3a7dc42b42293da6832d.js.map