System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      init_id = "query_id=AAF7JpQPAwAAAHsmlA_HUWGm&user=%7B%22id%22%3A6703818363%2C%22first_name%22%3A%22fei%22%2C%22last_name%22%3A%22wang%22%2C%22username%22%3A%22dfgsadsggfdn%22%2C%22language_code%22%3A%22zh-hans%22%2C%22allows_write_to_pm%22%3Atrue%7D&auth_date=1728489507&hash=6975149c4bd198d2b8c3b497ff24353b31c34d5216df61a9ed0bbf982e88d749";
      ...
      _export("trackUrl", trackUrl = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
        error: Error()
      }), GlobalData) : GlobalData).isProduction ? 'https://infinityg.ai/hall/api/telegram/user/src/add' : 'https://api.infinitytest.cc/hall/api/telegram/user/src/add');

      _export("loginUrls", loginUrls = {
        firstLoginCheck: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://infinityg.ai/api/v1/user/auth/first_login" : "https://api.infinitytest.cc/api/v1/user/auth/first_login",
        tgLogin: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://infinityg.ai/api/v1/user/auth/tg_login/webapp" : "https://api.infinitytest.cc/api/v1/user/auth/tg_login/webapp",
        pwdLogin: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://infinityg.ai/api/v1/user/auth/pwd_login" : "https://api.infinitytest.cc/api/v1/user/auth/pwd_login"
      });

      _export("twitterOauth", twitterOauth = {
        bindTwitter: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://infinityg.ai/api/v1/oauth/getTwitterCode" : "https://api.infinitytest.cc/api/v1/oauth/getTwitterCode",
        unBindTwitter: (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
          error: Error()
        }), GlobalData) : GlobalData).isProduction ? "https://infinityg.ai/api/v1/oauth/unboundTwitter" : "https://api.infinitytest.cc/api/v1/oauth/unboundTwitter"
      });
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        trackPath(path) {
          return _asyncToGenerator(function* () {
            var track = yield window.axios.post(trackUrl, {
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              var loginData = yield window.axios.post(loginUrls.tgLogin, {
                ...
                // }`,
                inviteCode: pathMaps.indexOf(inviteCode) < 0 && inviteCode ? JSON.parse(window.atob(inviteCode)).inviteCode : ""
              });
              ...
              if (loginData != null && (_loginData$data = loginData.data) != null && (_loginData$data$data = _loginData$data.data) != null && _loginData$data$data.token) {
                ...
                var path = new URLSearchParams(window.location.search).get("tgWebAppStartParam");

                if (pathMaps.indexOf(path) >= 0) {
                  _this2.trackPath(path);
                }
              }
            } catch (error) {
              console.log(error);
...
//# sourceMappingURL=abad76b59b30a05cbc442f15aace59b6eb7355ee.js.map