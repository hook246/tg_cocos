System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, tween, UIOpacity, inviteModel, profileModel, earnView, WebUtils, PromiseUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, homeView;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PromiseUtils = _unresolved_6.PromiseUtils;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("homeView", homeView = (_dec = ccclass('homeView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Node), _dec(_class = (_class2 = class homeView extends Component {
        ...
        shiftCurrentPage(btn, data) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.pageArray[Number(data)].getComponent(UIOpacity).opacity = 255;

            var currentPage = _this.pageArray.find((node, index) => {
              return _this.pageArray[index].getPosition().x === 0;
            });

            currentPage;
            (_tween = tween(currentPage.getComponent(UIOpacity))) == null ? void 0 : _tween.to(0.5, {
              opacity: 0
            }).start();
            yield (_crd && PromiseUtils === void 0 ? (_reportPossibleCrUseOfPromiseUtils({
              error: Error()
            }), PromiseUtils) : PromiseUtils).wait(0.5);
            currentPage.setPosition(-5000, 0); // this.pageArray.forEach((page: Node, index)=>{
...
//# sourceMappingURL=f5184782e8360bcbe0a20debd8d0844b900e762c.js.map