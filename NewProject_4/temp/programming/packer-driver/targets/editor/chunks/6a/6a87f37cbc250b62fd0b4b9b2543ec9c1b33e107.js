System.register(["__unresolved_0"], function (_export, _context) {
        ...
        var uxuyTgSdk = (() => {
          ...
          var L = (t, e) => () => (e || t((e = {
            ...
            for (var r in e) Nt(t, r, {
              ...
              On = (t, e, r, n) => {
            if (e && typeof e == "object" || typeof e == "function") for (let o of Na(e)) !Ca.call(t, o) && o !== r && Nt(t, o, {
              get: () => e[o],
          ...
          var qo = L((Wd, Bo) => {
            ...
            Bo.exports = function (e) {
              ...
              for (var n = rl(arguments, 1), o, i = function () {
 ...
 ` + e.prev;
          ...
          (function () {
            ...
            function y(h, w, _) {
              if (w || (w = function () {}), _ === void 0 && (_ = ""), console.log("[Telegram.WebView] > postEvent", h, _), window.TelegramWebviewProxy !== void 0) TelegramWebviewProxy.postEvent(h, JSON.stringify(_)), w();else if (window.external && "notify" in window.external) window.external.notify(JSON.stringify({
                eventType: h,
                eventData: _
              })), w();else if (i) try {
          ...
          function Ar() {
            ...
            for (let n = 0, o = arguments.length; n < o; n++) arguments[n] && ft(arguments[n], r);
          ...
          var vs = t => {
            ...
            return r(t, 0);
              ...
              Fn = ((t, e) => t ? setImmediate : e ? ((r, n) => (Ie.addEventListener("message", ({
            source: o,
            data: i
          }) => {
          ...
          var Pr = {
            ...
            transformResponse: [function (e) {
              let r = this.transitional || Pr.transitional,
 ...
 `).forEach(function (a) {
          ...
          var We = class {
            ...
            set(e, r, n) {
              ...
              let a = (s, u) => m.forEach(s, (f, d) => i(f, d, u));

              if (m.isPlainObject(e) || e instanceof this.constructor) a(e, r);else if (m.isString(e) && (e = e.trim()) && !Us(e)) a(eo(e), r);else if (m.isHeaders(e)) for (let [s, u] of e.entries()) i(u, s, n);else e != null && i(r, e, n);
              return this;
            }
 ...
 `);
          ...
          m.reduceDescriptors(We.prototype, ({
            value: t
          }, e) => {
          ...
          var zt = t => {
            ...
            if (m.isFormData(r)) {
              if (X.hasStandardBrowserEnv || X.hasStandardBrowserWebWorkerEnv) a.setContentType(void 0);else if ((u = a.getContentType()) !== !1) {
                let [f, ...d] = u ? u.split(";").map(y => y.trim()).filter(Boolean) : [];
          ...
          var qs = typeof XMLHttpRequest != "undefined",
            ...
            return new Promise(function (r, n) {
              ...
              function W() {
                if (!E) return;
                let h = Q.from("getAllResponseHeaders" in E && E.getAllResponseHeaders()),
                    _ = {
          ...
          var Fs = (t, e) => {
            let r = new AbortController(),
              ...
              if (!n) {
                n = !0, a();
                let f = u instanceof Error ? u : this.reason;
          ...
          var zs = function* (t, e) {
            ...
            for (; n < r;) o = n + e, yield t.slice(n, o), n = o;
              ...
              Hs = async function* (t, e, r) {
            for await (let n of t) yield* zs(ArrayBuffer.isView(n) ? n : await r(String(n)), e);
          },
              Ur = (t, e, r, n, o) => {
            let i = Hs(t, e, o),
                a = 0,
          ...
          var $t = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function",
              ...
              Wr = $t && (typeof TextEncoder == "function" ? (t => e => t.encode(e))(new TextEncoder()) : async t => new Uint8Array(await new Response(t).arrayBuffer())),
              po = (t, ...e) => {
            try {
              return !!t(...e);
            } catch (r) {
          ...
          var Ys = async t => {
            ...
            if (m.isSpecCompliantForm(t)) return (await new Request(t).arrayBuffer()).byteLength;
            if (m.isArrayBufferView(t) || m.isArrayBuffer(t)) return t.byteLength;
            if (m.isURLSearchParams(t) && (t = t + ""), m.isString(t)) return (await Wr(t)).byteLength;
          },
              Vs = async (t, e) => {
            let r = m.toFiniteNumber(t.getContentLength());
            ...
            try {
              if (u && $s && r !== "get" && r !== "head" && (j = await Vs(d, n)) !== 0) {
                let O = new Request(e, {
                  method: "POST",
                  body: n,
                  duplex: "half"
                ...
                if (m.isFormData(n) && (C = O.headers.get("content-type")) && d.setContentType(C), O.body) {
                  let [k, V] = Cr(j, je(Rr(u)));
                  n = Ur(O.body, uo, k, V, Wr);
                }
              }

              m.isString(y) || (y = y ? "include" : "omit"), E = new Request(e, { ...b,
                signal: x,
              ...
              if (jr && (s || w)) {
                ...
                let C = m.toFiniteNumber(h.headers.get("content-length")),
                    [k, V] = s && Cr(C, je(Rr(s), !0)) || [];
                h = new Response(Ur(h.body, uo, k, () => {
                  V && V(), w && W();
                }, Wr), O);
              }
              ...
              let _ = await Ht[m.findKey(Ht, f) || "text"](h, t);

              return !w && W(), v && v(), await new Promise((O, C) => {
                yt(O, C, {
                  data: _,
          ...
          var ho = t => `- ${t}`,
            ...
            getAdapter: t => {
              ...
              if (!n) {
                let i = Object.entries(o).map(([s, u]) => `adapter ${s} ` + (u === !1 ? "is not supported by the environment" : "is not available in the build")),
                    a = e ? i.length > 1 ? `since :
 ` + i.map(ho).join(`
 `) : " " + ho(i[0]) : "as no adapter specified";
                throw new P("There is no suitable adapter to dispatch the request " + a, "ERR_NOT_SUPPORT");
              }
 ...
 ` + i) : n.stack = i;
            ...
            _request(e, r) {
              ...
              let a = i && m.merge(i.common, i[r.method]);
          ...
          var oa = Pn(na());
          var Ce = {
            decodeTelegramUrlParameters: function (e, r = !0) {
            ...
            stringify: function (e) {
              ...
              function n(o, i) {
                ...
                });else if (typeof i == "object") for (let a in i) n(`${o}[${a}]`, i[a]);else r.append(o, i);
              }
            ...
            encodeTelegramUrlParameters: function (e, r = !0) {
 ...
 For more information, see: https://github.com/UXUYWallet/UXUYWallet-improvement-proposals/blob/main/MIPs/mip-1.md and https://github.com/UXUYWallet/UXUYWallet-improvement-proposals/blob/main/PROCESS-GUIDE.md#proposal-lifecycle`
          ...
          function Kc(t) {
            ...
            for (let n in e.properties) t[n] && (r[n] = t[n]);
          ...
          function sa(t) {
            ...
            try {
              t = Kc(t);
              let e = {};
              return t.types[t.primaryType].map(({
                name: n
              }) => {
                e[n] = t.message[n];
              }), t.message = e, t;
          ...
          var Qe = {
            ...
            async send(e, r) {
              let {
                ...
                id: i
                  ...
                  a = r.rpcUrl || this.getUrl(r.chainId),
                  s = {
                jsonrpc: "2.0",
                method: n,
                params: o,
            ...
            get(e) {
              try {
                let r = localStorage.getItem(`${this.prefix}${e}`);
          ...
          function Xc(t) {
            ...
            if (r) {
              let u = r == null ? void 0 : r.accounts;

              switch (u && (this._accounts = u), e) {
                case "wallet_switchEthereumChain":
                case "wallet_addEthereumChain":
                  let f = Object.values(this._accounts || {}).find(d => ge(d.chainId) === ge(i.chainId));
                  f ? this._account = { ...f
                  } : t.error = {
                    code: -32602,
          ...
          var pr = (() => {
            ...
            return (e, r, n = 1e3) => {
              ...
              Zc = (t, e = 1e3 * 60 * 15) => new Date().getTime() - t > e,
              dr = class extends It {
            constructor(r) {
              super({
                protocol: "eth"
            ...
            async _walletSwitchChain(r) {
              let {
                method: n,
                params: o
              } = r,
                  i = o[0],
                  a = Object.values(this._accounts || {}).find(s => ge(s.chainId) === ge(i.chainId));
              if (!a && (await this.request({
                method: "eth_requestAccounts"
              }), a = Object.values(this._accounts || {}).find(s => ge(s.chainId) === ge(i.chainId)), !a)) throw xt.invalidRequest({
                code: Tt.provider.unsupportedChain,
                message: Ge.errors.invalidChains(i == null ? void 0 : i.chainId),
                data: o
              });
              return this._account = a, null;
            }
            ...
            async request(r) {
              ...
              if (console.log("request", ...arguments), !r || typeof r != "object" || Array.isArray(r)) throw xt.invalidRequest({
              ...
              try {
                let y = `${n}-${JSON.stringify(o || [])}`;

                switch (n) {
                  case "eth_requestAccounts":
                    let b = Zc(this._lastTime, this.eventTimeout);
                    return (i = this == null ? void 0 : this._account) != null && i.address && !b ? [this._account.address] : pr(y, () => this._request(n, o));

                  case "eth_accounts":
                    return [(a = this._account) == null ? void 0 : a.address];

                  case "eth_chainId":
                    return (s = this._account) != null && s.chainId ? ge((u = this._account) == null ? void 0 : u.chainId) : null;

                  case "wallet_switchEthereumChain":
                  case "wallet_addEthereumChain":
                    return this.connected || (await this.request({
                      method: "eth_requestAccounts"
                    })), this._walletSwitchChain({
                      method: n,
                      params: o
                    });
                    break;
                  ...
                  case "eth_signTypedData_v4":
                    ...
                    let x = r.params[0];
                    return vn(r.params[0]) && !vn(r.params[1]) && (x = r.params[1]), o[0] = sa(x), pr(y, () => this._request(n, o));
                    break;

                  default:
                    return this.httpProvider.send(r, {
                      chainId: this.chainId,
                      chainKey: this.chainKey,
                      rpcUrl: ((d = (f = this._account) == null ? void 0 : f.rpcs) == null ? void 0 : d[0]) || ""
                    });
                }
              } catch (y) {
            ...
            async _request(r, n, o) {
              let i = this._account,
                  a = new Date().getTime();
              this._lastTime = a, o = {
                account: i,
                metaData: aa(this.metaData),
                ...o,
                timeStamp: a
              };
              let s = new Date().getTime() + Math.floor(Math.random() * 1e3).toString(),
                  u = `salt-${Date.now()}-${s}`,
                  f = {
                id: s,
                method: r,
                ...
                salt: u
                  ...
                  y = await vt.post(`${this.connectUrl}/transaction`, d, {
                headers: {
                  "X-Salt": u
                }
              }),
              ...
              let v = {
                ...
                params: [u, b, x]
                  ...
                  T = new EventSource(`${this.bridgeUrl}/events/${b}/${x}/${u}`);
              return new Promise((E, W) => {
                var w, _;

                let j = this.eventTimeout > 0 ? setTimeout(() => {
                  var O, C;
                  W(xt.invalidRequest({
                ...
                T.addEventListener("message", O => {
                  ...
                  try {
                    let k = JSON.parse(O == null ? void 0 : O.data);
                    console.log("message....parse", {
                      data: k,
                      publish_params: d
                    }), (k == null ? void 0 : k.id) == s || u == (k == null ? void 0 : k.salt) ? ((C = T == null ? void 0 : T.close) == null || C.call(T), clearTimeout(j), (k.reConnect || !k.error) && Xc.call(this, k), k.error ? W(k.error) : E(k.result)) : console.log("not match");
                  } catch (k) {
                    console.log(k);
                  }
                });
                let h = `${this.connect_direct_link}?startapp=uxuyconnect_${Ce.encodeTelegramUrlParameters(v)}`;
                ...
                if (Telegram.WebApp.initData && ((_ = (w = Telegram == null ? void 0 : Telegram.WebApp) == null ? void 0 : w.openTelegramLink) == null || _.call(w, h)), !Telegram.WebApp.initData) {
                  let O = this.connect_direct_link.match(/t\.me\/([^\/]+)\/([^\/]+)/);
          ...
          var mr = class extends Ct {
            constructor(r) {
              ...
              let n = r == null ? void 0 : r.metaData;
...
//# sourceMappingURL=6a87f37cbc250b62fd0b4b9b2543ec9c1b33e107.js.map