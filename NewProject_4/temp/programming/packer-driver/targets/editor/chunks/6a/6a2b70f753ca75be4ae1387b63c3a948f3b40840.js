System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("drawView", drawView = (_dec = ccclass("drawView"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Label), _dec11 = property(Label), _dec(_class = (_class2 = class drawView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        error: Error()
        ...
        setDrawLuckRewardInfo(rewardInfo) {} //展示当前的开奖信息


        showOpenRewardInfo() {} //设置当前的门票和usdt的信息


        setCurrentTicketsUsdtCount() {}
...
//# sourceMappingURL=6a2b70f753ca75be4ae1387b63c3a948f3b40840.js.map