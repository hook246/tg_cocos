System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Color, Label, Node, UITransform, basePageView, GlobalData, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _crd, ccclass, property, inviteView_arrow, inviteView;
    ...
    execute: function () {
      ...
      _export("inviteView", inviteView = (_dec = ccclass("inviteView"), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Label), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Node), _dec21 = property(Node), _dec(_class = (_class2 = class inviteView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "arrow", _descriptor19, this);

          _initializerDefineProperty(this, "arrow_s", _descriptor20, this);
        ...
        setInviteUrl() {
          this.invite_url.string = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).isProduction ? `https://t.me/InfinityGround_bot/Infinityg?startapp=${window.btoa(`{"inviteCode":"${(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).inviteCode}"}`)}` : `https://t.me/infinity_ground_bot/infinity_ground_app?startapp=${window.btoa(`{"inviteCode":"${(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).inviteCode}"}`)}`;
          this.copy_link = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).isProduction ? `https://t.me/InfinityGround_bot/Infinityg?startapp=${window.btoa(`{"inviteCode":"${(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).inviteCode}"}`)}` : `https://t.me/infinity_ground_bot/infinity_ground_app?startapp=${window.btoa(`{"inviteCode":"${(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
        ...
        shareInviteToFriend() {
          const shareText = "🔥Join the first AI gaming and meme creation platform on Telegram!\n🎮Experience infinite fun of AI games and memes and earn rewards.";
        ...
        writable: true,
        initializer: null
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "arrow", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "arrow_s", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=6ac10c8dad917eeb04a08109ca9c7e1b5804d7f8.js.map