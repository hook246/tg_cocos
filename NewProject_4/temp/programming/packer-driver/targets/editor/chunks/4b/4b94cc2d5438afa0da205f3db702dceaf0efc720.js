System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Label, Node, tween, UIOpacity, inviteModel, profileModel, earnView, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _crd, ccclass, property, homeView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("homeView", homeView = (_dec = ccclass('homeView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Button), _dec(_class = (_class2 = class homeView extends Component {
        constructor(...args) {
          super(...args);
        ...
        update(deltaTime) {
          ...
          if (this.public_text.getPosition().x > -600) {
            this.public_text.setPosition(this.public_text.getPosition().x - deltaTime * 30, 0);
          } else {
...
//# sourceMappingURL=4b94cc2d5438afa0da205f3db702dceaf0efc720.js.map