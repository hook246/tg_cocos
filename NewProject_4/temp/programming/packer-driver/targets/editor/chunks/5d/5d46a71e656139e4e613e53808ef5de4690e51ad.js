    ...
    execute: function () {
      ...
      _export("homeView", homeView = (_dec = ccclass('homeView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Node), _dec(_class = (_class2 = class homeView extends Component {
        ...
        async shiftCurrentPage(btn, data) {
          var _this$pageArray$this$, _this$pageArray$this$2;

          (_this$pageArray$this$ = this.pageArray[this.currentPageIndex]) == null ? void 0 : (_this$pageArray$this$2 = _this$pageArray$this$.getComponent(Animation)) == null ? void 0 : _this$pageArray$this$2.play();
          this.scheduleOnce(() => {
            this.pageArray[this.currentPageIndex].setPosition(-5000, 0);
            this.pageArray[this.currentPageIndex].setScale(1, 1);
          }, 1);
...
//# sourceMappingURL=5d46a71e656139e4e613e53808ef5de4690e51ad.js.map