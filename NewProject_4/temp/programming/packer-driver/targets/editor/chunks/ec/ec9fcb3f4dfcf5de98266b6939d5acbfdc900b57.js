System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, homeView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("homeView", homeView = (_dec = ccclass('homeView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Label), _dec11 = property(Node), _dec(_class = (_class2 = class homeView extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "game_point", _descriptor9, this);

          _initializerDefineProperty(this, "inviteBg", _descriptor10, this);
        ...
        shiftCurrentPage(btn, data) {
          this.pageArray.forEach((page, index) => {
            if (Number(data) === index) {
              ...
              this.inviteBg.setPosition(-5000, 0);
            }
          });
          console.log('======', btn);
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "game_point", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "inviteBg", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=ec9fcb3f4dfcf5de98266b6939d5acbfdc900b57.js.map