System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Node, Prefab, UITransform, basePageView, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, discoverView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("discoverView", discoverView = (_dec = ccclass("discoverView"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Prefab), _dec(_class = (_class2 = class discoverView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "scroll_node", _descriptor9, this);
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "scroll_node", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=ec4f4b358ca3b1ee2c4a7d233f6cc0d595fd6d29.js.map