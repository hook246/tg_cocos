        ...
        async shiftCurrentPage(btn, data) {
          ...
          this.pageArray.forEach((page, index) => {
            if (Number(data) === index) {
              ...
              this.pageArray[index].setScale(1, 1);
            } else if (Number(data) !== this.prePageIndex) {
              this.pageArray[this.currentPageIndex].setPosition(-5000, 0);
              this.pageArray[index].setScale(1, 1);
            } else {
              var _this$pageArray$this$, _this$pageArray$this$2;

              (_this$pageArray$this$ = this.pageArray[this.prePageIndex]) == null ? void 0 : (_this$pageArray$this$2 = _this$pageArray$this$.getComponent(Animation)) == null ? void 0 : _this$pageArray$this$2.play();
            }
          });
...
//# sourceMappingURL=4650f4f0dc6f7d06ec7f12c648fe32ffb6a78797.js.map