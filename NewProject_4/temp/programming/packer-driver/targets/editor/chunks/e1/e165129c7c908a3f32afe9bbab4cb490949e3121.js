System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Node, basePageView, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, discoverView;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventTouch', 'instantiate', 'Node', 'Sprite']);
        ...
        initGameViews(gameList) {
          gameList.forEach((game, index) => {
            ...
            (_crd && WebUtils === void 0 ? (_reportPossibleCrUseOfWebUtils({
              error: Error()
            }), WebUtils) : WebUtils).getRemoteImg(game.url, game_point.getChildByName('img'));
            this.father_node.addChild(game_point);
...
//# sourceMappingURL=e165129c7c908a3f32afe9bbab4cb490949e3121.js.map