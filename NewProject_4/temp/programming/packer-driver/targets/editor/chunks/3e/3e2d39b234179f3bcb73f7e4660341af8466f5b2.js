    ...
    execute: function () {
      ...
      _export("discoverView", discoverView = (_dec = ccclass("discoverView"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Prefab), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class discoverView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        ...
        openCurrentPlayUrl(event, data) {
          if (data === '1') {
            var _window, _window$Telegram, _window$Telegram$WebA, _window$Telegram$WebA2, _window$Telegram$WebA3;

            window.Telegram.WebApp.openTelegramLink(`${this.current_game_info.url}?startapp=TG${(_window = window) == null ? void 0 : (_window$Telegram = _window.Telegram) == null ? void 0 : (_window$Telegram$WebA = _window$Telegram.WebApp) == null ? void 0 : (_window$Telegram$WebA2 = _window$Telegram$WebA.initDataUnsafe) == null ? void 0 : (_window$Telegram$WebA3 = _window$Telegram$WebA2.user) == null ? void 0 : _window$Telegram$WebA3.id}`, {
              tryInstantView: true
            });
          } else {
            var _window2, _window2$Telegram, _window2$Telegram$Web, _window3, _window3$Telegram, _window3$Telegram$Web;

            window.Telegram.WebApp.openTelegramLink(`${this.current_ugc_info.url}?startapp=${window.btoa((_window2 = window) == null ? void 0 : (_window2$Telegram = _window2.Telegram) == null ? void 0 : (_window2$Telegram$Web = _window2$Telegram.WebApp) == null ? void 0 : _window2$Telegram$Web.initData)}`, {
              tryInstantView: true
            });
            console.log('====Telegram', `${this.current_ugc_info.url}?startapp=${window.btoa((_window3 = window) == null ? void 0 : (_window3$Telegram = _window3.Telegram) == null ? void 0 : (_window3$Telegram$Web = _window3$Telegram.WebApp) == null ? void 0 : _window3$Telegram$Web.initData)}`);
          }
        }
...
//# sourceMappingURL=3e2d39b234179f3bcb73f7e4660341af8466f5b2.js.map