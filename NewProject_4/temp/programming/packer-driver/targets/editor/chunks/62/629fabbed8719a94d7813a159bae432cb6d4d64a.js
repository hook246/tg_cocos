  ...
  return {
    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property({
        ...
        async updateDailyTaskUiByState(info, node, type, index) {
          ...
          if (type === ChangeType.INIT) {
            ...
            if (info.status === 2) {
              await this.claimReward((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
...
//# sourceMappingURL=629fabbed8719a94d7813a159bae432cb6d4d64a.js.map