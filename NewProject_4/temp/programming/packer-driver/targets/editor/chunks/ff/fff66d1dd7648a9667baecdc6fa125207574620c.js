System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, basePageModel, loginView, GlobalConfig, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, tg_token, walletType, walletChain, loginUrls, loginModel;
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        async tgLogin() {
          try {
            ...
            const encodeHasString = `auth_date=${window.Telegram.WebApp.initDataUnsafe.auth_date}0x0Afirst_name=${window.Telegram.WebApp.initDataUnsafe.user.first_name}0x0Aid=${window.Telegram.WebApp.initDataUnsafe.user.last_name}0x0Ausername=""`; //hex(HMAC_SHA256(data_check_string, secret_key)
...
//# sourceMappingURL=fff66d1dd7648a9667baecdc6fa125207574620c.js.map