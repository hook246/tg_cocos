        ...
        async start() {
          ...
          if (this.isUseMock) {
            window.Telegram.WebApp.initDataUnsafe = {
              ...
              authDate: this.isUseMock ? 1726658361 : window.Telegram.WebApp.initDataUnsafe.auth_date,
        ...
        async tgLogin() {
          try {
            ...
            const loginData = await window.axios.post(loginUrls.tgLogin, {
              ...
              photoUrl: `${this.isUseMock ? "" : window.Telegram.WebApp.initDataUnsafe.user.photo_url}`,
              username: ""
            });
...
//# sourceMappingURL=a63ba1a9140ffa776edae3702c61780a0cee0a51.js.map