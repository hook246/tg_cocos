System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, instantiate, Label, Node, Prefab, ProgressBar, basePageView, GlobalData, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, ChangeType, twitterTaskId, taskUrls, earnView;
        ...
        initSocialTaskNode(info) {
          info.taskResponseList.forEach((task, index) => {
            ...
            child.on(Button.EventType.CLICK, async () => {
              ...
              if (!(twitterTaskId.indexOf(this.taskInfo.data.data.taskModelResponses[0].taskResponseList[index].taskId) >= 0 && (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
...
//# sourceMappingURL=640f876d5a7ff0d6eb63da46fafd23b1d1a19c7f.js.map