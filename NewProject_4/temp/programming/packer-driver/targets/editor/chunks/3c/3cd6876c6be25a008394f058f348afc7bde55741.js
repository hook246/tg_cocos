System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      dataUrl = {
        game: ['images/avatar/btrump', 'images/avatar/cat', 'images/avatar/cat'],
      ...
      _export("UIScrollSelectHorizontal", UIScrollSelectHorizontal = (_dec = ccclass('UIScrollSelectHorizontal'), _dec2 = property(Node), _dec3 = property({
        ...
        onLoad() {
          ...
          for (var i = 0; i < this.scrollChildrenCount; i++) {
            const node_child = instantiate(this.instantiate_node); //WebUtils.getRemoteImg(this.scrollChildrenInfo[i].icon,node_child.getChildByName('icon'))
          ...
          this.scrollTo(0, false); //this.scrollChildrenInfo[i].type === 1 && this.scrollToLeft()
        ...
        */
        ...
        scrollToLeft() {
          this._toMoveX = 1;
          this.scrollChildrenInfo.length >= 2 && this.scrollTo(1); //this.scrollTo((this.currentIndex - 1 + this.childs.length) % this.childs.length)
        }
        /** 向左滚一个点 */
        ...
        update(dt) {
          ...
          let lx = this.childs[this.moveAim].position.x; //!2个child 先这么写过😧
          ...
          let cx = this.childs[this.moveAim].position.x; //!2个child 先这么写过😧
...
//# sourceMappingURL=3cd6876c6be25a008394f058f348afc7bde55741.js.map