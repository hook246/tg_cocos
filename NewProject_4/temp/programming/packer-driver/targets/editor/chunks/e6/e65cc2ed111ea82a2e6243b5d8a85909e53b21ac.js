  ...
  return {
    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass('earnView'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class earnView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        ...
        initTaskNode(type, info) {
          const parent = type ? this.social_parent : this.daily_parent;
          const child = type ? instantiate(this.social_prefab) : instantiate(this.daily_prefab);
...
//# sourceMappingURL=e65cc2ed111ea82a2e6243b5d8a85909e53b21ac.js.map