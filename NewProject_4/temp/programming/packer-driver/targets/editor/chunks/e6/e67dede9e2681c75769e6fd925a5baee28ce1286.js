        ...
        */
        ...
        scrollTo(idx, anim = true) {
          ...
          if (!anim) {
            ...
            // if(idx === 1){
            // 	this._checkChildX(this.childs[0], -this.deltaX)
            // 	this._checkChildX(this.childs[1], 0)
            // }else{
            // 	this._checkChildX(this.childs[0], 0)
            // 	this._checkChildX(this.childs[1], this.deltaX)
            // }
        ...
        scrollToLeft() {
          this._toMoveX = 1;
          this.scrollTo(3); //this.scrollTo((this.currentIndex - 1 + this.childs.length) % this.childs.length)
        }
        /** 向左滚一个点 */
...
//# sourceMappingURL=e67dede9e2681c75769e6fd925a5baee28ce1286.js.map