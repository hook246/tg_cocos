  ...
  return {
    ...
    execute: function () {
      ...
      Node.prototype.jump_to = function (targetPos, height, duration, callback) {
        const new_tween_postion = new Vec3(); //跳高

        let startPosY = 0;
        this.jump_y = 0;
        const y_tween = tween().to(duration / 2, {
          jump_y: height
        }, {
          onStart: my => {
        ...
        let offsetY = 0;
        const offset_y_tween = tween().to(duration, {
        ...
        const x_tween = tween().to(duration, {
          jump_x: targetPos.x
        }, {
          onUpdate: my => {
            new_tween_postion.set(my.position);
...
//# sourceMappingURL=386ee83fa41f09547f7c7fc2e45567b30fec63fd.js.map