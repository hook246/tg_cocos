        ...
        async shiftCurrentPage(btn, data) {
          ...
          this.pageArray.forEach((page, index) => {
            if (Number(data) === index) {
              ...
              this.pageArray[index].setPosition(-5000, 0); // tween(this.pageArray[index].getComponent(UIOpacity))?.to(0.5, { opacity: 0 }).start();
              // this.scheduleOnce(()=>{
...
//# sourceMappingURL=e44ef238f7dd626ba9bdef6578ae819888098883.js.map