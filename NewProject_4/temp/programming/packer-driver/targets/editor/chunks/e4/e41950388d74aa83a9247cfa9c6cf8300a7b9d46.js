System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, tween, UIOpacity, inviteModel, profileModel, earnView, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, homeView;
          ...
          this.pageArray.forEach(async (page, index) => {
            if (this.pageArray[index].getPosition().x === 0) {
              tween(this.pageArray[index].getComponent(UIOpacity)).to(0.5, {
                ...
                this.pageArray[index].getComponent(UIOpacity).opacity = 255(this.pageArray[Number(data)]).setPosition(0, 0);
              }).start(); // await PromiseUtils.wait(100)
              // this.pageArray[index].setPosition(-5000, 0);
            }
          });
          this.pageArray[Number(data)].setPosition(0, 0); // this.pageArray.forEach((page: Node, index)=>{
...
//# sourceMappingURL=e41950388d74aa83a9247cfa9c6cf8300a7b9d46.js.map