    ...
    execute: function () {
      ...
      _export("earnView", earnView = (_dec = ccclass("earnView"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property({
        ...
        async completeTask(id) {
          ...
          await window.axios(config).then(() => {}).catch(error => {
            console.log(error);
          });
        }
        ...
        async claimReward(id) {
          ...
          await window.axios(config).then(taskList => {}).catch(error => {
            console.log(error);
          });
        }
        ...
        initSocialTaskNode(info) {
          info.taskResponseList.forEach((task, index) => {
            ...
            child.on(Button.EventType.CLICK, async () => {
              if (this.taskInfo.data.data.taskModelResponses[0].taskResponseList[index].status === 3 || this.taskInfo.data.data.taskModelResponses[0].taskResponseList[index].status === 0) {
                return;
              }
              ...
              if (this.taskInfo.data.data.taskModelResponses[0].taskResponseList[index].status === 1) {
...
//# sourceMappingURL=da7a4818f655390814f72e6305b6f05d681626d5.js.map