System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Label, Node, tween, UIOpacity, inviteModel, profileModel, earnView, WebUtils, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _crd, ccclass, property, homeView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("homeView", homeView = (_dec = ccclass('homeView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Button), _dec16 = property(Node), _dec(_class = (_class2 = class homeView extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "public_elements", _descriptor15, this);
        ...
        async shiftCurrentPage(btn, data) {
          this.pageArray.forEach(async (page, index) => {
            if (this.pageArray[index].getPosition().x === 0) {
              if (Number(data) === index) {
                return;
              }

              tween(this.pageArray[index].getComponent(UIOpacity)).to(0.5, {
                opacity: 0
              }).call(() => {
                this.pageArray[index].setPosition(-5000, 0);
                this.pageArray[index].getComponent(UIOpacity).opacity = 255;
                this.pageArray[Number(data)].setPosition(0, 0);
              }).start();
            }
        ...
        async showProfile() {
          ...
          tween(this.profile.getComponent(UIOpacity)).to(0.5, {
            opacity: 255
          }).call(() => {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "public_elements", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=bc66cf6df7e50409dc95ea064064d62f143ad82c.js.map