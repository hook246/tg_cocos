    ...
    execute: function () {
      ...
      _export("loginModel", loginModel = (_dec = ccclass("loginModel"), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class loginModel extends (_crd && basePageModel === void 0 ? (_reportPossibleCrUseOfbasePageModel({
        ...
        async start() {
          ...
          if (tgId && code) {
            await this.bindTwitter(tgId, code, state);
            return;
          }
        ...
        async initOtherModel() {
          ...
          await this.invite.getComponent(_crd && inviteModel === void 0 ? (_reportPossibleCrUseOfinviteModel({
            error: Error()
          }), inviteModel) : inviteModel).initData(this.earn.getComponent(_crd && earnModel === void 0 ? (_reportPossibleCrUseOfearnModel({
            error: Error()
          }), earnModel) : earnModel).initData.bind(this.earn.getComponent(_crd && earnModel === void 0 ? (_reportPossibleCrUseOfearnModel({
            error: Error()
          }), earnModel) : earnModel)));
        }
...
//# sourceMappingURL=acbf73ba0f164cc07259a46db440eaa2af9b1fcc.js.map