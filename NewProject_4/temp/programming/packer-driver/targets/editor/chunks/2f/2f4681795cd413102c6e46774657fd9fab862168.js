      ...
      _export("UIScrollSelectHorizontal", UIScrollSelectHorizontal = (_dec = ccclass('UIScrollSelectHorizontal'), _dec2 = property(Node), _dec3 = property({
        ...
        */
        ...
        scrollTo(idx, anim = true) {
          ...
          if (!anim) {// for (var i = 0; i < this.childs.length; i++) {
        ...
        scrollToLeft() {
          this._toMoveX = 1;
          this.scrollTo(1, false); //this.scrollTo((this.currentIndex - 1 + this.childs.length) % this.childs.length)
        }
        /** 向左滚一个点 */
        ...
        scrollToRight() {
          this._toMoveX = -1;
          this.scrollTo(0, false); //this.scrollTo((this.currentIndex + 1 + this.childs.length) % this.childs.length)
        }
...
//# sourceMappingURL=2f4681795cd413102c6e46774657fd9fab862168.js.map