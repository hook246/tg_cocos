System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, RichText, tween, UIOpacity, basePageView, GlobalData, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _crd, ccclass, property, openRewardPos, drawView_arrow, drawView;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Label', 'Node', 'RichText', 'ScrollView', 'Sprite', 'tween', 'UIOpacity', 'Vec3']);
      ...
      _export("drawView", drawView = (_dec = ccclass("drawView"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Label), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(RichText), _dec19 = property(RichText), _dec(_class = (_class2 = class drawView extends (_crd && basePageView === void 0 ? (_reportPossibleCrUseOfbasePageView({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "tickets_cost", _descriptor9, this);

          //门票和usdt数量设置
          _initializerDefineProperty(this, "tickets", _descriptor10, this);

          _initializerDefineProperty(this, "usdt", _descriptor11, this);

          //开奖信息
          _initializerDefineProperty(this, "join_count", _descriptor12, this);

          _initializerDefineProperty(this, "timer", _descriptor13, this);

          _initializerDefineProperty(this, "draw_lucky_result", _descriptor14, this);

          _initializerDefineProperty(this, "good_result", _descriptor15, this);

          _initializerDefineProperty(this, "bad_result", _descriptor16, this);

          _initializerDefineProperty(this, "join_tips", _descriptor17, this);

          _initializerDefineProperty(this, "reward_info", _descriptor18, this);

          this.drawLuckyInfo = void 0;
          this.drawLuckyClose = void 0;
          this.cost_tickets = void 0;
        }
...
<color=#0fffff>Collect ${lessTickets} more to enter the draw</color>`;
        ...
        showDrawLuckRewardInfo(rewardInfo) {
          if (rewardInfo.join) {
            ...
            if (rewardInfo.win) {
              ...
              this.reward_info.string = `${rewardInfo}usdt`;
            } else {
        ...
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "tickets_cost", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "tickets", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "usdt", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "join_count", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
        ...
        writable: true,
        initializer: null
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "draw_lucky_result", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "good_result", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "bad_result", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "join_tips", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "reward_info", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=cf52968a86b28d05c5916cee82f45414c1774708.js.map